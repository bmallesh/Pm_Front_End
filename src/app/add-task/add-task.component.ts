...
export class AddTaskComponent implements OnInit {
  ...
  parentTaskCheck(){
    ...
    parentTasks
    getParentTask(){
      this.http.get(apis.getParentTask).subscribe(data=>{
    ...
    // ==========  Add Task  =============
    StartDate;EndDate;errorValidation=false;
    ...
    if(formvalidation.form.controls.Project.status=="VALID" && 
    formvalidation.form.controls.user.status=="VALID" && 
    formvalidation.form.controls.EndDate.status=="VALID" && 
    formvalidation.form.controls.StartDate.status=="VALID"){
      this.http.post(apis.addTask,task).subscribe(dt=>{
        // alert(dt._body);
    ...
    formvalidation.form.controls.StartDate.status=="VALID"){
      this.http.post(apis.updateTask,task).subscribe(dt=>{
        // alert(dt._body);
        this.cnacel()
